...
kernel void _occa_addVectors1_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int _occa_tiled_i = (entries - 1) - (((4) * 2) * _occa_group_position.x);
        {
...
kernel void _occa_addVectors2_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int _occa_tiled_i = (entries - 1) - ((4) * _occa_group_position.x);
        {
...
kernel void _occa_addVectors5_0(constant int& entries [[buffer(0)]],
    ...
    {
        int _occa_tiled_i =
            ((entries + 16)) - (((4) * (entries / 16 + 1)) * _occa_group_position.x);
        {
...
kernel void _occa_addVectors6_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int _occa_tiled_i = (entries - 1) - (((4) * 1) * _occa_group_position.y);
        {
...
kernel void _occa_addVectors7_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int _occa_tiled_i = (entries - 1) - (((4) * 1) * _occa_group_position.x);
        {
            ...
            if (i >= 0) {
                {
                    int _occa_tiled_j = (entries - 1) - (((4) * 1) * _occa_thread_position.y);
                    {
            ...
            if (i >= (entries - 12 + static_cast<int>(*a))) {
                {
                    unsigned long long _occa_tiled_j =
                        ((entries + 16)) - (((4) * (entries / 16 + 1)) * _occa_thread_position.y);
                    {
