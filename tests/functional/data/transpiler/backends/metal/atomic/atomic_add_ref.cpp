...
kernel void _occa_atomic_add_builtin_0(device const int* iVec [[buffer(0)]],
...
kernel void _occa_atomic_add_struct_0(device const ComplexTypeF32* vec [[buffer(0)]],
...
kernel void _occa_atomic_add_template_0(device const ComplexType<float>* vec [[buffer(0)]],
