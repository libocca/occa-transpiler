...
kernel void _occa_addVectors0_0(constant int& entries [[buffer(0)]],
    ...
    {
        int j = (entries - 1) - ((1) * _occa_group_position.x);
        {
            int i = (entries - 1) - ((1) * _occa_thread_position.x);
            ab[i] = add(a[i], b[i]);
        }
    }
}
...
kernel void _occa_addVectors1_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int j = (entries - 1) - ((2) * _occa_group_position.x);
        {
            int i = (entries - 1) - ((2) * _occa_thread_position.x);
            ab[i] = add(a[i], b[i]);
        }
    }
}
...
kernel void _occa_addVectors2_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int j = (entries - 1) - _occa_group_position.x;
        {
            int i = (entries)-_occa_thread_position.x;
            ab[i] = add(a[i], b[i]);
        }
    }
}
...
kernel void _occa_addVectors3_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int j = (entries - 1) - _occa_group_position.x;
        {
            int i = (entries - 1) - _occa_thread_position.x;
            ab[i] = add(a[i], b[i]);
        }
    }
}
...
kernel void _occa_addVectors4_0(constant int& entries [[buffer(0)]],
                                ...
                                uint3 _occa_thread_position [[thread_position_in_threadgroup]]) {
    {
        int i = (entries - 1) - _occa_group_position.y;
        {
            int j = (entries - 1) - _occa_group_position.x;
            {
                int k = (entries - 1) - _occa_thread_position.y;
                {
                    int ii = (entries - 1) - _occa_thread_position.x;
                    ab[ii + k] = add(a[i], b[j]);
                }
            }
        }
