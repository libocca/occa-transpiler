...
extern "C" void addVectors0(occa::modeKernel_t **deviceKernels,
                            ...
                            occa::modeMemory_t *b, occa::modeMemory_t *ab) {
  {
    ...
    inner.dims = 1;
    int j = entries - 1;
    outer[0] = (1 + (entries - 1) - (0) + (1) - 1) / (1);
    int i = entries - 1;
    inner[0] = (1 + (entries - 1) - (0) + (1) - 1) / (1);
...
extern "C" void addVectors1(occa::modeKernel_t **deviceKernels,
                            ...
                            occa::modeMemory_t *b, occa::modeMemory_t *ab) {
  {
    ...
    inner.dims = 1;
    int j = entries - 1;
    outer[0] = (1 + (entries - 1) - (0) + (2) - 1) / (2);
    int i = entries - 1;
    inner[0] = (1 + (entries - 1) - (0) + (2) - 1) / (2);
    occa::kernel kernel(deviceKernels[0]);
    kernel.setRunDims(outer, inner);
    kernel(entries, a, b, ab);
  };
...
extern "C" void addVectors4(occa::modeKernel_t **deviceKernels,
                            ...
                            occa::modeMemory_t *b, occa::modeMemory_t *ab) {
  {
    ...
    inner.dims = 2;
    int i = entries - 1;
    outer[1] = 1 + (entries - 1) - (0);
    int j = entries - 1;
    outer[0] = 1 + (entries - 1) - (0);
    int k = entries - 1;
    inner[1] = 1 + (entries - 1) - (0);
    int ii = entries - 1;
    inner[0] = 1 + (entries - 1) - (0);
    occa::kernel kernel(deviceKernels[0]);
    kernel.setRunDims(outer, inner);
