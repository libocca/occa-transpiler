...
_occa_atomic_sub_builtin_0(__global const int *iVec, __global int *iSum,
...
__kernel __attribute__((reqd_work_group_size(1, 1, 1))) void
_occa_atomic_sub_struct_0(__global const ComplexTypeF32 *vec,
...
__kernel __attribute__((reqd_work_group_size(1, 1, 1))) void
_occa_atomic_sub_template_0(__global const ComplexType<float> *vec,
