...
extern "C" [[sycl::reqd_work_group_size(5, 3, 2)]] void _occa_test0_0(sycl::queue* queue_,
...
extern "C" [[sycl::reqd_work_group_size(7, 5, 3)]] void _occa_test0_1(sycl::queue* queue_,
                                                                      sycl::nd_range<3>* range_,
                                                                      const int entries,
                                                                      const float* a,
                                                                      const float* b,
