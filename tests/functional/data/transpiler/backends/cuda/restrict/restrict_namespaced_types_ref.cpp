...
extern "C" __global__ void _occa_function1_0(const A::Complex<float>* __restrict__ vectorData,
                                             unsigned int vectorSize,
                                             const A::Complex<float>** __restrict__ matricesData,
                                             const A::B::Configs* __restrict__ matricesSizes) {}

// TODO: fix me when @kernel/@outer/@inner are implemented
extern "C" __global__ void _occa_function2_0(const A::Complex<float>* __restrict__ vectorData,
